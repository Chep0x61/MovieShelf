...
### Manage completly (Create, Read, Update, Delete) your list movie list as you wish totally on the web interface. 
...
## Features
#### Little preview of the biggest features of the bot
